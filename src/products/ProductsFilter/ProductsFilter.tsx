...
export default function ProductsFilter() {
    ...
    return (
        <div className="flex justify-end relative">
            ...
            {open ? (
                <div className="fixed bottom-0 left-0 px-4 pb-4 max-h-125 overflow-y-auto w-full border-none rounded-t-3xl bg-white shadow-[#ccc] shadow-3 sm:absolute sm:bottom-auto sm:top-10 sm:left-auto sm:right-0 sm:w-full sm:rounded-lg ">
